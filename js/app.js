...
const getReportedPosts = () => {
  return posts.filter((post) => reportedPostsId.includes(post.id));   /* return value works correctly */
};
...
};  /* if description length more then 30, it will show 'read more' else full text */
...
const createPost = (post) => {
  ...
  const userImage = post.userImage;   /* User Image added to the top of the every post */
                  ...
                  <div class="post__description">
                    <small>
                      <a class="post__name--underline" href="#">
                          ${post.comments[0]?.user /* Commented username added */}
                      </a>
                      ${post.comments[0]?.text  /* Comment goes here */}
                    </small>
                  </div>
...
const displayReportedPosts = () => {
  ...
  reportedPosts.forEach((post) => {   /* exploring reportedPosts works correctly */
    const div = createPost(post);
